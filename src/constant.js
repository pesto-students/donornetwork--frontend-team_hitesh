...
export const blogArray = [ 
    {
      heading: "The day before",
      points: 'If you are thinking, "What good would it do to donate my blood!", then keep reading. Many people hesitate to donate blood, thinking it is a tedious process and that they faint after that. First, let’s bust the myths about donating blood. These are the reasons why potential and existing...'
    },
    {
      heading: "On the Donation day",
      points:
