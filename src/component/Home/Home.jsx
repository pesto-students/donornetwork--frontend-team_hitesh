...
const Home = () => {
  const images = [require("../../images/Banner.png")];
  return (
    <>
      <main>
        <div className="hom">
        ...
        <div id="aboutus">
          ...
          <div className="aboutcontent">
            <div className="abouttext">
              ...
              significant difference in someone's life, and our goal is to make
              the process as simple and convenient as possible.
              <br />
            ...
            <div className="chartimg">
              ...
              <p>
                *After donating blood, the body works to replenish the blood
                ...
                production of new blood cells and in turn, helps in maintaining
                good health.
                <br /> <br />
              </p>
              <p>
                * human body contains five liters of blood, which is made of
                ...
                <br /> *Your blood donation determines the best donation for you
                to make. For plasma and platelet <br />
